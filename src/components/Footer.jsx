        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            dark:text-gray-400'>
                ...
                <ul className='flex gap-8'>
                    <li><a className='hover:text-primary' href='#home'/>Home</li>
                    <li><a className='hover:text-primary' href='#services'/>Services</li>
                    <li><a className='hover:text-primary' href='#our-work'/>Our Work</li>
                    <li><a className='hover:text-primary' href='#contact-us'/>Contact Us</li>
                </ul>
            </motion.div>
            <motion.div 
            initial={{opacity: 0 ,x: 30}}
            ...
            <hr className='border-gray-300 dark:bordr-gray-600 my-6'/>
