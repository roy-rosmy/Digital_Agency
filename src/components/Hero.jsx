...
const Hero = () => {
  return (
    ...
    overflow-hidden text-gray-700 dark:text-white'>
        ...
        x1:leading-[95px] max-w-5xl'>Turning Imagination into <span className='bg-gradient-to-r from-[#5044E5]
        to-[#4d8cea] bg-clip-text text-transparent'>digital</span> impact.</motion.h1>
        ...
        75 max-w-4/5 sm:ax-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive 
